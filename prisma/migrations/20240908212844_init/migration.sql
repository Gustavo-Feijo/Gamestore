...
CREATE TABLE "ShoppingItems" (
    ...
    CONSTRAINT "ShoppingItems_pkey" PRIMARY KEY ("userId","gameId")
);
...
-- AddForeignKey
ALTER TABLE "ShoppingItems" ADD CONSTRAINT "ShoppingItems_gameId_fkey" FOREIGN KEY ("gameId") REFERENCES "Game"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShoppingItems" ADD CONSTRAINT "ShoppingItems_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
